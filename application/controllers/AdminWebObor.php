...
class AdminWebObor extends CI_Controller {
    ...
    public function dash() {
        ...
        $this->load->view('adminObor/welcome', $data);
    }
    public function contact_us() {
        ...
        $this->load->view('adminObor/dataKomen', $data);
    }
    public function user() {
        ...
        $this->load->view('adminObor/dataUser', $data);
    }
    ...
    function simpan() {
        $file = upload('file', './upload/obor/fotoKeluarga', false);
        ...
        if ($this->input->post('jenis') == 1) {
            ...
            redirect('AdminWebObor/' . $direct);
        } else {
            $this->Model_dop->insert_table("m_treat", $data);
            redirect('AdminWebObor/treatmentDetail/' . base64_encode($jenis));
        }
    }
    ...
    public function simpanFileVideo($code) {
        ...
        $this->load->view('head', $data);
        $this->load->view('adminObor/inputLink');
    }
    ...
    public function slider() {
        ...
        $data['group_id'] = 1;
        $this->load->view('adminObor/dataIndex', $data);
    }
    ...
    public function treatmentDetail($idEnc) {
        ...
        $data['group_id'] = $id;
        $this->load->view('adminObor/dataIndexTreat', $data);
    }
    ...
    public function youtube() {
        ...
        $this->load->view('adminObor/dataIndexMedia', $data);
    }
