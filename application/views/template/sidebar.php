        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="<?php echo base_url().'index.php/adm/user';?>"><i class="fa fa-circle-o text-warning"></i> User</a></li>
                    <li><a href="<?php echo base_url().'index.php/adm/userRole';?>"><i class="fa fa-circle-o text-warning"></i> User Role</a></li>
                    <li><a href="<?php echo base_url().'index.php/adm/menu';?>"><i class="fa fa-circle-o text-warning"></i> Menu</a></li>
                    <li><a href="<?php echo base_url().'index.php/adm/menuRole';?>"><i class="fa fa-circle-o text-warning"></i> Menu Role</a></li>
                    <li>
